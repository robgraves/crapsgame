...
def credits():
	...
	print("			                    ")
	time.sleep(1.0)
	print("			https://github.com/robgraves/crapsgame ")
	time.sleep(1.0)
	print("			                    ")
	time.sleep(1.0)
...
if music == 1:
	if operating == "Linux":
		...
		introwinsound = subprocess.Popen("powershell -c (New-Object Media.SoundPlayer 'data\\sounds\\tonight.wav').PlaySync();")
	elif operating == "Darwin":
